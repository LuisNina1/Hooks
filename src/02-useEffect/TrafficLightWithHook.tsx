import { useTraffictLight } from "../hooks/useTrafficLight";


export const TrafficLightWithHook = () => {
  const { countDown, percentage , redLight, greenLight, yellowLight} = useTraffictLight()
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-gray-900 to-slate-800 flex items-center justify-center p-4">
      <div className="flex flex-col items-center space-y-8">

        <h1 className="text-white">Semaforo con useEffect</h1>
        <h2 className="text-white">{countDown}</h2>
